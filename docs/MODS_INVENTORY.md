...
| --- | --- | --- | --- | --- | --- |
| `0.0.11-alpha` (see `pack.toml`) | `1.21.1` | `0.18.4` | 86 (83 + 1 + 2) | 5 | 2 |
...
| Set World Spawn Point | [modrinth.com/mod/set-world-spawn-point](https://modrinth.com/mod/set-world-spawn-point) | Utility, Server | server | low | Collective | — | — | Spawn commands (server). |
