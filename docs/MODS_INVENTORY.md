...
- **Last reconciled:** 2026-03-31 — **Active** rows vs `mods/*.pw.toml` (26) + `shaderpacks/*.pw.toml` (1) + `resourcepacks/*.pw.toml` (2), `pack.toml` `0.0.8-alpha`; **Listed** 1 (ParCool!); **Discarded** 1 (**First Person Model**). **`main`** omits **Wall-Jump TXF**; **`dev`** includes it.
