...
| ItemPickupNotifier | [modrinth.com/mod/itempickupnotifier](https://modrinth.com/mod/itempickupnotifier) | QoL, UI | client | medium | — | — | — | Pinned to Modrinth **1.21.10** file; verify on **1.21.1**. |
