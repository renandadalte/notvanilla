...
## [Unreleased]
### Added
- Datapack **`benchmark`**: voo spectator automatizado ~60s (`function benchmark:start`) para runs repetíveis com Spark; fluxo documentado na skill local `notvanilla-spark-benchmark`.
